 ...
 * 用于更改显示大小位置缩放
 */
var scaleSelectCustomScale = 100;
...
function getViewerConfiguration() {
  return {
    ...
    sidebar: {
      ...
      saveButton: document.getElementById('saveToggle'),
      ...
      sureSignButton: document.getElementById('viewsureSign'),
      sureSignView: document.getElementById('sureSignView'),
      styleCssButton: document.getElementById('viewstyleCss'),
      styleCssView: document.getElementById('styleCssView')
    },
    sidebarResizer: {
      outerContainer: document.getElementById('outerContainer'),
...
function webViewerTextLayerRendered(evt) {
  // console.dir("-----页面生成html---之后调用------------------")
  // console.dir(evt)
  loadPdf();
  cookieInitSet();
  // console.dir("----html-----html----------------"+scaleSelectCustomScale)
...
function webViewerPageChanging(evt) {
  ...
  scrollViewUpSelectIntoView(page);
...
var PDFSidebar = function () {
  function PDFSidebar(options, eventBus) {
    ...
    this.eventBus = eventBus;
    this.l10n = l10n;
    this.sureSignButton = options.sureSignButton;
    this.sureSignView = options.sureSignView;
    this.styleCssButton = options.styleCssButton;
    this.saveButton = options.saveButton;
    this.styleCssView = options.styleCssView;
    this._addEventListeners();
  }
  ...
  _createClass(PDFSidebar, [{
    ...
    value: function switchView(view) {
      ...
      switch (view) {
        case SidebarView.THUMBS:
          ...
          this.sureSignButton.classList.remove('toggled');
          this.sureSignView.classList.add('hidden');
          this.styleCssButton.classList.remove('toggled');
          this.styleCssView.classList.add('hidden');
        ...
        case SidebarView.SURESIGN:
          ...
          this.sureSignButton.classList.add('toggled');
          this.sureSignView.classList.remove('hidden');
          this.styleCssButton.classList.remove('toggled');
          this.styleCssView.classList.add('hidden');
          break;
        case SidebarView.STYLECSS:
          this.thumbnailButton.classList.remove('toggled');
          this.outlineButton.classList.remove('toggled');
          this.attachmentsButton.classList.remove('toggled');
          this.thumbnailView.classList.add('hidden');
          ...
          this.sureSignButton.classList.remove('toggled');
          this.sureSignView.classList.add('hidden');
          this.styleCssButton.classList.add('toggled');
          this.styleCssView.classList.remove('hidden');
          break;
        default:
    ...
    value: function _addEventListeners() {
      ...
      this.viewerContainer.addEventListener('mouseup', function (evt) {
        //alert($(this).html());
        // if (evt.target === _this3.viewerContainer) {
        //   _this3.outerContainer.classList.remove('sidebarMoving');
        // }
      });
      // this.viewerContainer.addEventListener('click',function(e){
      //   // alert(2);
      ...
      //       //   });
      //       // alert($(this).html());
      //      alert($(this).children().children().find(".textLayer>div").attr("style"))
      //     }
      // });

      this.saveButton.addEventListener('click', function () {
        // var postils = getCookie("sureSign");
        // if(postils!=null)
        //     _pdf_save._params = {};
        // var pdfCookie = getCookie("pdfCookie");
        // if(pdfCookie!=null)
        //     _pdf_save._params = {};
        // _pdf_save._get();
          alert("暂无保存")
      });
      this.sureSignButton.addEventListener('click', function () {
        _this3.switchView(SidebarView.SURESIGN);
      });
      this.styleCssButton.addEventListener('click', function () {
        _this3.switchView(SidebarView.STYLECSS);
      });
  ...
  _createClass(TextLayerBuilder, [{
    ...
    value: function _bindMouse() {
      ...
      div.addEventListener('mouseup', function (evt) {
        ...
        //alert("鼠标抬起"+(evt.target==mousedownDiv));
        //alert(window.getSelection().toString());
        //alert(evt.target.tagName)
        findSelectText(mousedownEvt,evt)
        if (_this3.enhanceTextSelection && _this3.textLayerRenderTask) {
...
var Toolbar = function () {
  ...
  _createClass(Toolbar, [{
    ...
    value: function _bindListeners() {
      ...
      // items.editBtn.addEventListener('click', function () {
      //   alert("1");
      //   $(".page").off("click");
      // });
      items.markedBtn.addEventListener('click', function () {
        //点一次添加消息的cursor，在页面上添加完一个标注后就失去cursor
        $("#viewer").addClass("cursorMarked");
      });
    ...
    value: function _updateUIState() {
      ...
      scaleSelectCustomScale = customScale
